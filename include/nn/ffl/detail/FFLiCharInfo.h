...
typedef enum FFLiVerifyCharInfoReason
{
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_FACELINE_TYPE_INVALID      =  1,
    FFLI_VERIFY_CHAR_INFO_REASON_FACELINE_COLOR_INVALID     =  2,
    FFLI_VERIFY_CHAR_INFO_REASON_FACELINE_TEXTURE_INVALID   =  3,
    FFLI_VERIFY_CHAR_INFO_REASON_FACELINE_MAKE_INVALID      =  4,
    FFLI_VERIFY_CHAR_INFO_REASON_HAIR_TYPE_INVALID          =  5,
    FFLI_VERIFY_CHAR_INFO_REASON_HAIR_COLOR_INVALID         =  6,
    FFLI_VERIFY_CHAR_INFO_REASON_HAIR_FLIP_INVALID          =  7,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_EYE_ASPECT_INVALID         = 11,
    FFLI_VERIFY_CHAR_INFO_REASON_EYE_ROTATE_INVALID         = 12,
    FFLI_VERIFY_CHAR_INFO_REASON_EYE_X_INVALID              = 13,
    FFLI_VERIFY_CHAR_INFO_REASON_EYE_Y_INVALID              = 14,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_EYEBROW_ASPECT_INVALID     = 18,
    FFLI_VERIFY_CHAR_INFO_REASON_EYEBROW_ROTATE_INVALID     = 19,
    FFLI_VERIFY_CHAR_INFO_REASON_EYEBROW_X_INVALID          = 20,
    FFLI_VERIFY_CHAR_INFO_REASON_EYEBROW_Y_INVALID          = 21,
    FFLI_VERIFY_CHAR_INFO_REASON_NOSE_TYPE_INVALID          = 22,
    FFLI_VERIFY_CHAR_INFO_REASON_NOSE_SCALE_INVALID         = 23,
    FFLI_VERIFY_CHAR_INFO_REASON_NOSE_Y_INVALID             = 24,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_MOUTH_ASPECT_INVALID       = 28,
    FFLI_VERIFY_CHAR_INFO_REASON_MOUTH_Y_INVALID            = 29,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_MUSTACHE_Y_INVALID         = 34,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_GLASS_Y_INVALID            = 38,
    FFLI_VERIFY_CHAR_INFO_REASON_MOLE_TYPE_INVALID          = 39,
    FFLI_VERIFY_CHAR_INFO_REASON_MOLE_SCALE_INVALID         = 40,
    FFLI_VERIFY_CHAR_INFO_REASON_MOLE_X_INVALID             = 41,
    FFLI_VERIFY_CHAR_INFO_REASON_MOLE_Y_INVALID             = 42,
    ...
    FFLI_VERIFY_CHAR_INFO_REASON_CREATORNAME_INVALID        = 46,
    FFLI_VERIFY_CHAR_INFO_REASON_GENDER_INVALID             = 47,
    FFLI_VERIFY_CHAR_INFO_REASON_BIRTHDAY_INVALID           = 48,
    FFLI_VERIFY_CHAR_INFO_REASON_FAVORITECOLOR_INVALID      = 49,
    FFLI_VERIFY_CHAR_INFO_REASON_REGIONMOVE_INVALID         = 50,
    FFLI_VERIFY_CHAR_INFO_REASON_FONTREGION_INVALID         = 51,
    FFLI_VERIFY_CHAR_INFO_REASON_ROOM_INDEX_INVALID         = 52,
    FFLI_VERIFY_CHAR_INFO_REASON_POSITION_IN_ROOM_INVALID   = 53,
    FFLI_VERIFY_CHAR_INFO_REASON_BIRTH_PLATFORM_INVALID     = 54,
    FFLI_VERIFY_CHAR_INFO_REASON_CREATEID_INVALID           = 55
}
