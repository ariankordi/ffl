...
void InitPrimitive(FFLPrimitiveParam* pPrimitive)
{
    ...
    static const u16 INDEX_BUFFER[INDEX_COUNT] = { 0, 1, 2, 2, 1, 3 };
#else
    pPrimitive->primitiveType = rio::Drawer::TRIANGLE_STRIP;
    static const u16 INDEX_BUFFER[INDEX_COUNT] = { 0, 1, 2, 3 };
#endif
...
void InitAttributes(FFLAttributeBufferParam* pAttributes, u32 resolution)
{
    ...
    rio::MemUtil::copy(pAttributes->attributeBuffers[FFL_ATTRIBUTE_BUFFER_TYPE_TEXCOORD].ptr, TEXCOORD_BUFFER, TEXCOORD_BUFFER_SIZE);
